...
<qgis version="2.14.7-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="geplande_woningen" forceraster="0" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor" enableorderby="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="208,242,237,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="161,218,226,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
    ...
    <colorramp type="gradient" name="[source]">
      <prop k="color1" v="208,242,237,255"/>
      <prop k="color2" v="37,52,148,255"/>
      <prop k="discrete" v="0"/>
      <prop k="stops" v="0.25;161,218,226,255:0.5;65,182,196,255:0.75;44,127,184,255"/>
    </colorramp>
...
Nieuwe woningen: [% "net_nieuwe_woningen" %]&lt;br>
&lt;br>
Gemiddelde bereikbaarheid: [% round("gemiddelde_bereikbaarheidsindex",2) %]&lt;br>
Maximale bereikbaarheid: [% "maximale_bereikbaarheidsindex" %]</displayfield>
  <label>0</label>
  <labelattributes>
