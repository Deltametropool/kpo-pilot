...
from kpo_datasysteem_pilot_dockwidget import KPOpilotDockWidget
from kpo_dataexplorer import KPOExplorer
...
class KPOpilot:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&KPO datasysteem pilot')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'KPOpilot')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('KPOpilot', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'KPO datasysteem pilot'),
            callback=self.run,
    ...
    def unload(self):
        ...
        #print "** UNLOAD KPOpilot"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&KPO datasysteem pilot'),
                action)
